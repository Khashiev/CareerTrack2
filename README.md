...
Ты упакуешь собственное резюме в соответствии с основными правилами для выбранной вакансии или стажировки. Правильно опишешь навыки,  опыт и финансовые ожидания, а также составишь сопроводительное письмо, учитывая собственные пожелания и ожидания от вакансии.
...
1. **Указывайте Фамилию и Имя**  
Отчество в диджитал-среде не обязательно указывать, исключение может быть только, если вы хотите в госсектор/банки.

2. **Почта! Никаких kotletka@, princesska@, kotik@**  
Давайте оставим эти почты для спам-магазинов. 
...
4. **Укажите, свой никнейм в телеграм** (только не kotik желательно).  
...
5. **Вставить ссылку на портфолио (по желанию).**
...
Посмотреть еще раз вакансии, которые тебе нравятся и выбрал. Выписать самые часто встречающиеся навыки в описании и соотнести со твоим  опытом.  
...
Главный ответ, который хочет получить работодатель, глядя на твое резюме: “Чем ты был полезны прошлому работодателю?”  
3. Вернись к анализу вакансий. Посмотри, какие требования и обязанности к вакансиям. Это твоя главная подсказка при написании резюме.
...
**1. Название компании**  
Если ты работал в крупной компании, скорее всего любой нанимающий hr-менеджер знает эти компании и такое резюме придает вес к опыту.  
Если ты работал в малоизвестной фирме, то желательно написать, что выделяет эту компанию, сфера деятельности компании. Обычно эту информацию можно найти на сайте самой компании. Возможно, компания лидер в какой-либо индустрии, работает с крупными клиентами (Сбер, Яндекс и т.д). Все это можно указать в резюме.  

**2. Годы работы**  

- Указывайте только месяцы и года. Не нужно писать точные даты приема и увольнения. Не нужно указывать в резюме в каждом опыте работы сколько месяцев ты  отработал в компаниях.  
_Например:_ март 2018 - апрель 2020  
Если ты работаешь на момент поиска работы, то можно указать так:
март 2018 - по наст.время  

- Всегда указывайте опыт работы с последнего (текущего места) к первому вашему опыту.
Если у вас рваный опыт работы: по 3-4 месяца на каждом месте работы. Можно объединить в проектную деятельность/фриланс.   

-  Можно не указывать какие-то места, на собеседовании сказать, что были в поиске работы и проходили собеседования. (Стандартный поиск работы может занимать от 3 до 6 месяцев - это нормально).
...
**3. Должность**   
Указывай ту, которую ты занимал. Желательно, чтобы твоя должность и желаемая позиция были одинаковыми. 
...
Важно!
Никогда не переписывай должностные инструкции. Их никто читать не будет. Тут важно написать, что ты делал, какие задачи перед тобой стояли.
...
В резюме же ты пишешь результат своей деятельности в работе. 
...
**5. Результаты**  
Этот пункт самый важный в резюме. Компании-работодателю всегда интересно, какие результаты ты сделал. Поэтому желательно результаты оцифровать.
...
2. Самостоятельно искать фриланс-проекты, которые можно и нужно занести в портфолио. 
...
5. Программистам можно участвовать в  [Open Source проектах](https://tproger.ru/articles/open-source-for-beginners/).   
6. В твой опыт включаем участие в кейс-чемпионатах и хакатонах.  
...
_Совет №1:_  
1. В разделе можно указать вашу цель. Напишите, почему ты любишь свою работу, что тебя вдохновляет?  
...
## Где сделать резюме?  
1. Ты можешь сделать резюме на hh.ru.  
...
7. В последнее время очень стильно выглядит резюме в Notion.  
...
| ------ | ------ |
| 1. Отсутствие достижений в вашем опыте работы | Расписать не только твои обязанности, но и указать твои KPI.Например:  - вошел в ТОП-3 лучших студентов курса; - являлся наставником для 5+ сокурсников, оказывал помощь в освоении программы обучения - выполнил 30+ учебных проектов. KPI – это измеримые показатели твоей  работы. Эти данные показывают твою  эффективность, и то, что интересно работодателю. |
| 2. Указан неверный уровень владения иностранным языком | Будьте честны, указывайте тот, который у тебя  есть на данный момент. Начальный уровень (Beginner); Элементарный уровень (Elementary); Ниже среднего (Pre-Intermediate); Средний (Intermediate); Выше среднего (Upper Intermediate);  Продвинутый (Advanced); Супер продвинутый (Mastery). |
| 3. Орфографические ошибки в резюме | Попроси проверить резюме друга, преподавателя или на [сайте](https://glvrd.ru/) |
| 4. Некорректные зарплатные ожидания | Изучите рынок зарплат в твоей отрасли и в твоем регионе |
...
**Шаг 1.** 
Проведите анализ компании/вакансии/проекта. 
...
**Шаг 3.**
Составьте сопроводительное письмо, используя структуру:  
1. Краткое приветствие (Если знаете имя HR-менеджера, то можно поприветствовать в письме).  
...
3. Интерес к вакансии/компании/проекту (Ответ на вопрос: Почему компания интересна вам?).       
4. Сильные стороны, исходя из желаемой должности (Ответ на вопрос: Почему этой компании вы можете быть интересны?).   
...
В открытых источниках много информации о средней “вилке” специалистов., в. 
...
Для ведения переговоров о зарплате,  как и на стадии трудоустройства, так и при разговоре о повышении,  важно понимать, сколько ваш труд стоит на рынке:   
- Подготовьтесь к вопросу «Почему/за что работодатель должен повышать зарплату? Тут важно, что вы показываете результаты и ваш труд в компании  приносит пользу/деньги. Тогда и подготовьте небольшой отчет о проделанной работе. Что вы делали/Что сделали? Как было/Как стало? Что улучшилось благодаря вашей работе/Какие показатели стали больше/меньше за счет чего/ каких ресурсов? 
- Посмотрите самостоятельно аналитику вакансий. Ты сделал аналитику вакансий в прошлом проекте. Это тоже твоя подсказка для переговоров о зарплате.  
